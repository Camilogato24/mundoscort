	...
	<div id="primary" <?php astra_primary_class(); ?>>
		<div class="bl_wrapper">
			<svg id="svg_tramp" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
				...
				<text transform="matrix(1 0 0 1 354 346)" class="text_forgiveness">No</text>
				<text transform="matrix(1 0 0 1 351 372)">
					<tspan x="0" y="0" class="text_forgiveness">Existe</tspan>
					<tspan x="0" y="31" class="text_forgiveness">esta URL</tspan>
				</text>
			</svg>
